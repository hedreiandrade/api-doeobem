...
-- Copiando dados para a tabela api-doeobem.comments: ~8 rows (aproximadamente)
...
-- Copiando dados para a tabela api-doeobem.followers: ~16 rows (aproximadamente)
...
-- Copiando dados para a tabela api-doeobem.likes: ~19 rows (aproximadamente)
...
-- Copiando dados para a tabela api-doeobem.posts: ~11 rows (aproximadamente)
...
INSERT INTO `posts` (`id`, `description`, `media_link`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(11, 'teste', '', '2025-11-24 23:21:44', '2025-11-25 02:21:53', '2025-11-25 02:21:53'),
	(12, 'Qual a boa pro final de semana ? 👏🎶✌❤', '', '2025-11-24 23:36:10', '2025-11-24 23:36:10', NULL),
	(13, 'linda foto ', 'https://hmediaha.s3.us-west-2.amazonaws.com/imagesVideos/posts/d41d8cd98f00b204e9800998ecf8427e_iasmincora/media_692516374f8b67.09266770.jpg', '2025-11-24 23:36:40', '2025-11-24 23:36:40', NULL);
...
-- Copiando dados para a tabela api-doeobem.posts_users: ~11 rows (aproximadamente)
...
INSERT INTO `posts_users` (`id`, `user_id`, `post_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(13, 3, 13, '2025-11-24 23:36:40', '2025-11-24 23:36:40', NULL);
...
-- Copiando dados para a tabela api-doeobem.users: ~6 rows (aproximadamente)
...
INSERT INTO `users` (`id`, `name`, `nickname`, `phone1`, `has_whatsapp`, `phone2`, `email`, `password`, `postal_code`, `street`, `number`, `complement`, `neighborhood`, `city`, `state`, `country`, `recovery_key`, `first_access`, `last_access`, `access_count`, `receive_newsletter`, `active`, `created_at`, `updated_at`, `deleted_at`, `userscol`, `photo`, `cover_photo`, `google_id`, `facebook_id`, `auth_provider`, `email_verified`, `verified_profile`) VALUES
	...
	(6, 'Jeniffer Cora', NULL, NULL, 0, NULL, 'jeniffer@gmail.com', '$2y$10$RLe8jkyB73i5KNYnFRiR5efclCwowVvD1KaQwCDTJqYfRrsayIVx6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-24 13:26:09', '2025-11-24 22:57:27', 2, 0, 1, '2025-11-24 13:26:09', '2025-11-25 02:35:00', NULL, NULL, 'https://hmediaha.s3.us-west-2.amazonaws.com/images/profile/f73599fffd54f314ee59a4379278c366_jeniffercora/374066667dubai.jpg', '', NULL, NULL, 'local', 1, 0),
	(7, 'Mora Dias', NULL, NULL, 0, NULL, 'mora@gmail.com', '$2y$10$RLe8jkyB73i5KNYnFRiR5efclCwowVvD1KaQwCDTJqYfRrsayIVx6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-24 13:26:09', '2025-11-24 22:57:27', 2, 0, 1, '2025-11-24 13:26:09', '2025-11-25 01:52:16', NULL, NULL, '', '', NULL, NULL, 'local', 1, 0),
	(233, 'Hedrei Andrade', NULL, NULL, 0, NULL, 'hedreiandrade@gmail.com', '$2y$10$RLe8jkyB73i5KNYnFRiR5efclCwowVvD1KaQwCDTJqYfRrsayIVx6', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-24 13:26:09', '2025-11-25 02:19:47', 3, 0, 1, '2025-11-24 13:26:09', '2025-11-25 02:30:28', NULL, NULL, 'https://hmediaha.s3.us-west-2.amazonaws.com/images/profile/45ffe4526a174467d18531ced45e90df_hedreiandrade/2048186498ha.jpg', 'https://hmediaha.s3.us-west-2.amazonaws.com/images/cover/d41d8cd98f00b204e9800998ecf8427e_hedreiandrade/2075300663capayoutube.jpg', NULL, NULL, 'local', 1, 0);
